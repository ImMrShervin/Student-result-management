...
return [
    ...
    'use' => 'default',
    'prefix' => env('HORIZON_PREFIX', 'srms_horizon:'),
    'middleware' => ['web'],
    ...
    'memory_limit' => 64,
    'defaults' => [
        'supervisor-1' => ['connection' => 'redis', 'queue' => ['default'], 'balance' => 'auto', 'autoScalingStrategy' => 'time', 'maxProcesses' => 1, 'maxTime' => 0, 'maxJobs' => 0, 'memory' => 128, 'tries' => 1, 'timeout' => 60, 'nice' => 0],
    ],
    'environments' => [
