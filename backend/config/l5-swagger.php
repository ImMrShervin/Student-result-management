...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => ['title' => 'SRMS API Documentation'],
    ...
    'defaults' => [
        ...
        'validator_url' => null,
        'ui' => ['display' => ['dark_mode' => true, 'doc_expansion' => 'none', 'filter' => true]],
        'constants' => ['L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://localhost:8000/api/v1')],
    ],
];
